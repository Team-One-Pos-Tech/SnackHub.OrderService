Feature: Cancel Order Use Case

    Scenario: Valid order confirmed, cancel should succeed
        ...
        And confirming the order with client id '919806ea-f94d-401b-a1f6-9a15291c4125' and product details table:
          | ProductId                            | Quantity |
